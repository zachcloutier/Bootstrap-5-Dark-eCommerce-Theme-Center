 ...
 */
class MDB_Widget_Bestsellers extends WC_Widget {

    public function __construct() {
        $this->widget_description = __( 'Show bestsellers', 'mdb_ecommerce' );
        $this->widget_id          = 'mdb_widget_bestsellers';
        $this->widget_name        = __( 'MDB - Bestsellers', 'mdb_ecommerce' );
        $this->settings           = array(
            'title'         => array(
                'type'  => 'text',
                'std'   => __( 'Bestsellers', 'mdb_ecommerce' ),
    ...
    public function widget_start( $args, $instance ) {
        ...
        $title = '<i class="fas fa-fire me-2 text-warning"></i> ' . apply_filters( 'widget_title', $this->get_instance_title( $instance ), $instance, $this->id_base );
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! isset( $instance['title'] ) ) {
            $instance['title'] = __( 'Bestsellers', 'mdb_ecommerce' );
        }
        ...
        $loop = new WP_Query( $bestsellers_args );
        $product_count = 0;
        $query_count = 0;
