 ...
 */
class MDB_Widget_Products_New extends WC_Widget {

    public function __construct() {
        $this->widget_description = __( 'Show all new products', 'mdb_ecommerce' );
        $this->widget_id          = 'mdb_widget_products_new';
        $this->widget_name        = __( 'MDB - New products', 'mdb_ecommerce' );
        $this->settings           = array(
            'title'         => array(
                'type'  => 'text',
                'std'   => __( 'New products', 'mdb_ecommerce' ),
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! isset( $instance['title'] ) ) {
            $instance['title'] = __( 'New products', 'mdb_ecommerce' );
        }
